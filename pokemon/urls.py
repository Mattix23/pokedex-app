...
urlpatterns = [
    ...
    path('favorite-pokemon/pokemon-list/<int:pk>/delete', views.PokemonDeleteView.as_view(), name='pokemon_delete'),
    path('favorite-pokemon/pokemon-list', views.PokemonListView.as_view(), name='pokemon_list'),
